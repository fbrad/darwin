...
class CharacterBertModel(BertPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs
        ...
        #print("[character_bert:82] kwargs = ", kwargs)
        ...
        #print("[character_bert] type(encoder_outputs) = ", type(encoder_outputs))
        #print("[character_bert] encoder_outputs = ", encoder_outputs)
